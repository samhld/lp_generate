...
def gen_tag_key_set(tag_keys, tag_key_size, kwargs):
    '''
    Generates a set of Tag Keys to be iterated over to create full Tags.
    '''
    if tag_keys:
...
def gen_tag_val_set(tag_values, tag_value_size, kwargs):
    '''
    Generates a set of Tag Values to be iterated over to create full Tags.
    '''
    if tag_values:
...
def gen_tagset(tag_keys, tag_values, kwargs):
    '''
    Generates full Tagset out of key/value sets.
    '''
...
def _gen_int_fieldset(int_field_keys, kwargs):
    ...
    return(int_fieldset[1:]) # Removes preceding comma generated by each generated Field from `gen_int_field`
...
def _gen_float_fieldset(float_field_keys, kwargs):
    ...
    return(float_fieldset[1:]) # Removes preceding comma generated by each generated Field from `gen_float_field`
...
def _gen_str_fieldset(str_field_keys, kwargs):
    ...
    return(str_fieldset[1:]) # Removes preceding comma generated by each generated Field from `gen_str_field`


def gen_fieldset(int_field_keys, float_field_keys, str_field_keys, kwargs):
    '''
    Generates full fieldset to used in generation of a line of Line Protocol
    '''
